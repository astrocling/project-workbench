 ...
 * Anyone with one of these roles can be used in key role fields.
 * Matched to Person by email, or by name (firstName + lastName).
 * Creates a Person for key-role users who have no matching Person.
 */
