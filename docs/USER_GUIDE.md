...
- **Present and PDF** — **Present** sits with **View** / **Edit** and Gantt zoom. It slims the left column to names and status, labels bars and diamonds, and uses more of the window height. **Fit** is the default zoom in Present (your Work zoom comes back when you click **View**/**Edit**, toggle **Present** off, or press **Escape**). **Download PDF** (same toolbar) exports a **US Letter landscape** two-page plan: timeline with kickoff/launch/duration, then phase detail and assumptions. It is not a screenshot of the editor grid.
