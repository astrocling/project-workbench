...
| **Blank Plan has no way to add an item** | Fixed after **1.3.0**: a plan with no phases opens in **Edit** with **+ Add phase**. After you add a phase, **+ Add item** sits under that phase. If you only see names and the Gantt, click **Edit**. |
| **Status report timeline covers Completed / Upcoming / Risks** | Fixed after **1.3.0**: **Project timeline** slides use compact 14px rows again. **Project Plan** slides stay taller so key dates sit under phase bars. Hard-refresh preview. |
