...
3. Confirm to replace the budget stored on this report with current Budget tab totals and spend-to-date. On **CDA** reports this also updates the overall budget dollars on the slide. Timeline, milestones, and other snapshot data are **not** affected.
