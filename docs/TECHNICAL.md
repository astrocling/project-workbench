...
| `POST /api/projects/[id]/slack/weekly-lookahead` | Session (User/Admin) | Post current-week team + Plan/Timeline dates to the **project** channel (`Project.slackChannelId`). Overview **Post week to Slack** (`ProjectDetailTabs.tsx`). Empty POST body. |
