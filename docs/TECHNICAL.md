...
- **Migrations**: `20260903120000_add_project_plan`, `20260903140000_plan_items_meetings_nesting`, `20260903183710_add_project_plan_beta`, `20260908180000_plan_report_visibility_and_status` (shipped in **1.3.0**). `20260903140000` **drops `PlanMeeting`**; that table only existed earlier in this 1.3.0 series (added by `20260903120000`) and was replaced by meeting fields on `PlanItem`, so no prior released deployment can hold data in it.
