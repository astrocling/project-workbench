...
2. Set **`SEED_ADMIN_EMAIL`** and **`SEED_ADMIN_PASSWORD`** in Vercel for production; they are required (default credentials are not used in production). Then log in with those credentials.
