...
export default function NewProjectPage() {
  ...
  return (
    <div>
      <div className="mb-6">
        <Link href="/projects" className="text-jblue-500 dark:text-jblue-400 hover:text-jblue-700 dark:hover:text-jblue-200 font-medium text-body-sm">
          ← Projects
        </Link>
      </div>
      <h1 className="text-display-md font-bold text-surface-900 dark:text-white mb-6">New Project</h1>
      <form onSubmit={handleSubmit} className="space-y-4 bg-white dark:bg-dark-surface p-6 rounded-lg border border-surface-200 dark:border-dark-border shadow-card-light dark:shadow-card-dark max-w-xl">
        {error && (
